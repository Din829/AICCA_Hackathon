...
def create_app() -> FastAPI:
    ...
    # from .routes.database import database_router  # REMOVED: AICCA不需要数据库路由
    from .routes.websocket import websocket_router
    
    # 注册路由
    app.include_router(chat_router, prefix="/api/chat", tags=["chat"])
    # app.include_router(database_router, prefix="/api/database", tags=["database"])  # REMOVED: AICCA不需要
