...
class CodeExecutionTool(DatabaseTool):
    ...
    def __init__(self, config: DatabaseConfig, i18n=None):
        ...
        description = f"[TEMPORARILY DISABLED - DO NOT USE] This tool is temporarily disabled for AICCA. Please do not call this tool. Execute code in multiple languages. Supports: {', '.join(lang_descriptions)}."
